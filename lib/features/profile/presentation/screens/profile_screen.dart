...
/// The Profile tab body: avatar, contact info, a stats strip, and a menu
/// card. Rendered inside [AppShell]'s Scaffold, so it has no Scaffold or
        ...
        children: [
          const Center(
            child: CircleAvatar(
              ...
              child: Text(_initials, style: AppTypography.h1),
            ),
          ),
          const SizedBox(height: AppSpacing.lg),
          Text(_fullName, style: AppTypography.h1, textAlign: TextAlign.center),
          ...
          Row(
            ...
            children: [
              const Icon(LucideIcons.mapPin, size: 14, color: AppColors.ink300),
